    ...
    <section className="relative min-h-[80vh] w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 mx-auto flex min-h-[80vh] max-w-7xl flex-col items-center justify-center px-6 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center gap-3">
          <Link to="/auth" className="inline-flex items-center rounded-md bg-indigo-600 px-5 py-3 text-white font-medium hover:bg-indigo-500 transition">
            Get Started
            <ArrowRight className="ml-2 h-5 w-5" />
          </Link>
          <Link to="/resources" className="inline-flex items-center rounded-md bg-white/10 px-5 py-3 text-white font-medium hover:bg-white/20 transition">
            Explore Resources
          </Link>
        </div>
      </div>
